...
### SBOM Редактор
Просмотр, редактирование, валидация и объединение CycloneDX SBOM. Визуальный редактор компонентов, поддержка ГОСТ-полей, мгновенное автосохранение, файловый менеджер проектов.
